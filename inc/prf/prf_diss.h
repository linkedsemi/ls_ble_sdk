...
enum diss_evt_type
{
    DIS_SERVER_PROFILE_ADDED,
    DIS_SERVER_SET_VALUE_RSP,
    DIS_SERVER_GET_VALUE_IND,
};

struct diss_profile_added_evt
{
    uint16_t start_hdl;
};
...
union diss_evt_u
{
    struct diss_profile_added_evt profile_added;
...
void prf_dis_server_add(uint8_t sec_lvl,uint16_t features);
