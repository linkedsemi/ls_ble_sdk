...
echo hexmerge.py .\UVBuild\info_sbl.hex %2\dev\soc\arm_cm\le501x\bin\fw.hex .\UVBuild\ble_uart_server.hex .\UVBuild\%1_production_%date:~0,4%%date:~5,2%%date:~8,2%_%time:~0,2%%time:~3,2%%time:~6,2%.hex
 hexmerge.py .\UVBuild\info_sbl.hex %2\dev\soc\arm_cm\le501x\bin\fw.hex .\UVBuild\ble_uart_server.hex > .\UVBuild\%1_production_%date:~0,4%%date:~5,2%%date:~8,2%_%time:~0,2%%time:~3,2%%time:~6,2%.hex
