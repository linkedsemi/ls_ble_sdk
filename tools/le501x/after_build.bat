%2\tools\srec_cat.exe -Output .\UVBuild\info_sbl.hex -Intel %2\dev\soc\arm_cm\le501x\bin\bram.bin -Binary -Offset 0x18000300 %2\tools\le501x\info.bin -Binary -Offset 0x18000000
