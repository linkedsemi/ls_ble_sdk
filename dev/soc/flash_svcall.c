...
SVCALL(SVCALL_FLASH_CHIP_ERASE,void,do_spi_flash_chip_erase_svcall());
...
SVCALL(SVCALL_FLASH_PROGRAM_SECURITY,void,do_spi_flash_program_security_svcall(uint8_t idx, uint16_t addr, uint8_t * data, uint16_t length));
