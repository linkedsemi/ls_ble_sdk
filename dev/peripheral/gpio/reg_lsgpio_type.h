...
{
    GPIO_AE0_MASK = (int)0x1,
    GPIO_AE0_POS = 0,
    GPIO_AE1_MASK = (int)0x2,
    GPIO_AE1_POS = 1,
    GPIO_AE2_MASK = (int)0x4,
    GPIO_AE2_POS = 2,
    GPIO_AE3_MASK = (int)0x8,
    GPIO_AE3_POS = 3,
    GPIO_AE4_MASK = (int)0x10,
    GPIO_AE4_POS = 4,
    GPIO_AE5_MASK = (int)0x20,
    GPIO_AE5_POS = 5,
    GPIO_AE6_MASK = (int)0x40,
    GPIO_AE6_POS = 6,
    GPIO_AE7_MASK = (int)0x80,
    GPIO_AE7_POS = 7,
    GPIO_AE8_MASK = (int)0x100,
    GPIO_AE8_POS = 8,
    GPIO_AE9_MASK = (int)0x200,
    GPIO_AE9_POS = 9,
    GPIO_AE10_MASK = (int)0x400,
    GPIO_AE10_POS = 10,
    GPIO_AE11_MASK = (int)0x800,
    GPIO_AE11_POS = 11,
    GPIO_AE12_MASK = (int)0x1000,
    GPIO_AE12_POS = 12,
    GPIO_AE13_MASK = (int)0x2000,
    GPIO_AE13_POS = 13,
    GPIO_AE14_MASK = (int)0x4000,
    GPIO_AE14_POS = 14,
    GPIO_AE15_MASK = (int)0x8000,
    GPIO_AE15_POS = 15,
};
