...
{
    CRYPT_DATA0_MASK = 0xffffffff,
    CRYPT_DATA0_POS = 0,
};

enum CRYPT_REG_DATA1_FIELD
{
    CRYPT_DATA1_MASK = 0xffffffff,
    CRYPT_DATA1_POS = 0,
};

enum CRYPT_REG_DATA2_FIELD
{
    CRYPT_DATA2_MASK = 0xffffffff,
    CRYPT_DATA2_POS = 0,
};

enum CRYPT_REG_DATA3_FIELD
{
    CRYPT_DATA3_MASK = 0xffffffff,
    CRYPT_DATA3_POS = 0,
};

enum CRYPT_REG_KEY0_FIELD
{
    CRYPT_KEY0_MASK = 0xffffffff,
    CRYPT_KEY0_POS = 0,
};

enum CRYPT_REG_KEY1_FIELD
{
    CRYPT_KEY1_MASK = 0xffffffff,
    CRYPT_KEY1_POS = 0,
};

enum CRYPT_REG_KEY2_FIELD
{
    CRYPT_KEY2_MASK = 0xffffffff,
    CRYPT_KEY2_POS = 0,
};

enum CRYPT_REG_KEY3_FIELD
{
    CRYPT_KEY3_MASK = 0xffffffff,
    CRYPT_KEY3_POS = 0,
};

enum CRYPT_REG_KEY4_FIELD
{
    CRYPT_KEY4_MASK = 0xffffffff,
    CRYPT_KEY4_POS = 0,
};

enum CRYPT_REG_KEY5_FIELD
{
    CRYPT_KEY5_MASK = 0xffffffff,
    CRYPT_KEY5_POS = 0,
};

enum CRYPT_REG_KEY6_FIELD
{
    CRYPT_KEY6_MASK = 0xffffffff,
    CRYPT_KEY6_POS = 0,
};

enum CRYPT_REG_KEY7_FIELD
{
    CRYPT_KEY7_MASK = 0xffffffff,
    CRYPT_KEY7_POS = 0,
};

enum CRYPT_REG_IVR0_FIELD
{
    CRYPT_IVR0_MASK = 0xffffffff,
    CRYPT_IVR0_POS = 0,
};

enum CRYPT_REG_IVR1_FIELD
{
    CRYPT_IVR1_MASK = 0xffffffff,
    CRYPT_IVR1_POS = 0,
};

enum CRYPT_REG_IVR2_FIELD
{
    CRYPT_IVR2_MASK = 0xffffffff,
    CRYPT_IVR2_POS = 0,
};

enum CRYPT_REG_IVR3_FIELD
{
    CRYPT_IVR3_MASK = 0xffffffff,
    CRYPT_IVR3_POS = 0,
};

enum CRYPT_REG_RES0_FIELD
{
    CRYPT_RES0_MASK = 0xffffffff,
    CRYPT_RES0_POS = 0,
};

enum CRYPT_REG_RES1_FIELD
{
    CRYPT_RES1_MASK = 0xffffffff,
    CRYPT_RES1_POS = 0,
};

enum CRYPT_REG_RES2_FIELD
{
    CRYPT_RES2_MASK = 0xffffffff,
    CRYPT_RES2_POS = 0,
};

enum CRYPT_REG_RES3_FIELD
{
    CRYPT_RES3_MASK = 0xffffffff,
    CRYPT_RES3_POS = 0,
};
